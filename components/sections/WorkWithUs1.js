		...
		<>
			...
			<section className="tf-section work-with-us">
				<div className="themesflat-container">
							...
							<div className="col-12">
								<ul className="widget-menu-tab wow fadeInUp">
									<li className="item-title">
										<span className="inner">All Properties</span>
									</li>
									<li className="item-title active">
										<span className="inner">For Buy</span>
									</li>
									<li className="item-title">
							...
							<div className="widget-content-inner">
								<div className="row">
									<div className="col-xl-4 col-md-6 col-12">
										<div className="box-dream style-absolute">
											<div className="image">
									...
									<div className="col-xl-4 col-md-6 col-12">
										<div className="box-dream style-absolute">
											<div className="image">
												...
												<img className="w-full" src="/images/house/featured-5.jpg" alt="" />
											</div>
											<div className="content">
												<div className="head">
													<div className="title">
									...
									<div className="col-xl-4 col-md-6 col-12">
										<div className="box-dream style-absolute">
											<div className="image">
												...
												<img className="w-full" src="/images/house/featured-6.jpg" alt="" />
											</div>
											<div className="content">
												<div className="head">
													<div className="title">
														<Link href="/property-single-v1">Office Space at
															Northwest</Link>
													</div>
												</div>
												<div className="location">
					...
					<div className="row">
						<div className="col-12">
							<Link href="/property-list-v1" className="tf-button-primary border-radius-corner m-auto wow fadeInUp">See All Listing<i className="icon-arrow-right-add" /></Link>
						</div>
					</div>
				</div>
			</section>
