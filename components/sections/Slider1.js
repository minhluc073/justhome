							...
							<div className="row">
								<div className="col-12">
									<div className="slider-content">
										<div className="sub wow fadeInUp" data-wow-delay="0.1s">LET US GUIDE YOUR HOME
										</div>
										<h1 className=" wow fadeInUp" data-wow-delay="0.2s">Discover a place you'll love
											to live</h1>
											...
											<div className="widget-content-tab">
												...
												<div className="widget-content-inner">
													<form className="form-search-content flex-grow">
														<fieldset className="name">
															<input type="text" placeholder="Enter an address, neighborhood, city, or ZIP code" className="show-search style-2" name="name" tabIndex={2} aria-required="true" required />
														</fieldset>
														<div className="button-submit style-absolute-right">
															<button className="style-icon-bg" type="submit"><i className="flaticon-magnifiying-glass" /></button>
														</div>
